...
//			};
	...
	var App = {
		...
		exitAppFromBandCard:function(event){
			...
			exec("App", "exitAppFromBandCard", JSON.stringify(json));
		},
		...
		jumpToRecertify : function(){
			...
			exec("App", "jumpToRecertify", JSON.stringify(json));
		},
		/**
		 * 跳转到绑卡界面
		 */
		jumpToBindCard : function(){
            ...
            exec("App", "jumpToBindCard", JSON.stringify(json));
		},
		/**
		 * 跳转到解绑界面
		 */
		jumpToUnBindCard : function(){
            ...
            exec("App", "jumpToUnBindCard", JSON.stringify(json));
		},
		/**
		 * 获取应用ID
		 * 
        ...
        setFinishIconHidden : function(){
            ...
            exec("App", "setFinishIconHidden", JSON.stringify(json));
        },
    ...
    /**
		 ...
		 *@param bound (true|false)   true:返回键交给js处理，false:js还给原生处理
		 */
	...
	var exec = function(service, action, args) {
		console.log("exec:"+service+'_'+action);
	...
	var exec_asyn = function(service, action, args, success, fail) {
		console.log("exec_asyn:"+service+'_'+action);
		var json = {
			"service" : service,
			"action" : action
		};
