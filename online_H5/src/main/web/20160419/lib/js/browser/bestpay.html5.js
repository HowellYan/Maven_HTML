define(['dummy/browser/user', 'dummy/browser/app', 'dummy/browser/security'], function(UserDummy, AppDummy, SecurityDummy){
	...
	var User = {
		...
		getSuccessLoginInfo : function() {
            return JSON.stringify(UserDummy.getSuccessLoginInfo);
		},
...
//			};
	...
	var App = {
         ...
         * 获取设备基本信息
         * 返回参数格式：
         * {'model': 'Google Nexus S - 4.1.1 - API 16 - 480x800', 'systemType' : 'Android', 'systemVersion' : '4.1.1',
         * 'imei' : '', 'imsi' : ''}
         */
        getDeviceInfo : function() {
            return JSON.stringify(AppDummy.getDeviceInfo);
        }
	}
